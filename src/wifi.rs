use embedded_svc::wifi::{AuthMethod, ClientConfiguration, Configuration, PmfConfiguration, ScanMethod};
...
pub fn connect_wifi(modem: Modem, ssid: &str, password: &str) -> anyhow::Result<AsyncWifi<EspWifi<'static>>> {
